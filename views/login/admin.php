...
<div  id="cont1">
	<div id="encabezado">
		...
		<table border=0 >
			<tr>
				<td>
  					<form method="post" action="<?php echo URL; ?>views/login/admin.php" > <input type="submit" value="Inicio" ></form>
          </td>
          <td>
...
<div id="global">
  <div id="mensajes">
    ...
    <b><div class="texto"><a href="<?php echo URL; ?>views/login/admin.php">Inicio</a></div></b>
...
<div id="perfiles" style="float: right;">
	<font size=15><p>Hola <?php echo $_SESSION['name']; ?></p></font> <br>
